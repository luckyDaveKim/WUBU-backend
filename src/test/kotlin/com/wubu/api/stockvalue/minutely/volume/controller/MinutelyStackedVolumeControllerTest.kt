...
import com.wubu.api.stockvalue.minutely.volume.service.MinutelyStackedVolumeFindService
...
class MinutelyStackedVolumeControllerTest(
    ...
    fun `특정일 누적 데이터 조회 테스트`() {
        ...
        val resultActions: ResultActions = mockMvc.perform(
            MockMvcRequestBuilders.get("/api/minutely/stacked/volume/companies/{companyCode}", companyCode.value)
